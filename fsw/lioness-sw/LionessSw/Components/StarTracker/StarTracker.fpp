module Components {
    ...
    passive component StarTracker {
        ...
        # Output image port: Receives raw image data from the camera. The buffer contains pixel data that the star tracker will process to detect stars and compute centroids.
        output port getPicture: LionessSw.GetPicture
