 ...
 * FlatSat::TopologyState see: FlatSatTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type FlatSat::TopologyState see: FlatSatTopologyDefs.hpp.
 *
